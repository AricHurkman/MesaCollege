...
public class MovieCapturePanel extends JPanel
{
  ...
  private MovieCapture movieCapturer = null;
  ...
  {
    /** set up the parts */
    MovieCapture movieCapture = new MovieCapture(directory);
    buttonPanel = new CaptureButtonPanel(movieCapture,shapeComponent);
    shapeComponent.setVideoCapture(movieCapture);
